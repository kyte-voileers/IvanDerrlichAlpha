...
function UsefulLinks({clickHandler}) {
    return(
        <div 
            className={socialMediaStyles.container}
            id="useful-links"
        >
            ...
            <div 
                    ...
                    onClick={()=> clickHandler('https://docs.google.com/document/d/1lrhSStY2TPPkS6f9qoiwWPSaCV17LJR26hgureLlcdA')}
                    onAuxClick={()=> clickHandler('https://docs.google.com/document/d/1lrhSStY2TPPkS6f9qoiwWPSaCV17LJR26hgureLlcdA')}
                >
                ...
                <div 
                    className={socialMediaStyles.button}
                    onClick={()=> clickHandler('https://www.credential.net/profile/ivanalejandroderlichderlich65413')}
                    onAuxClick={()=> clickHandler('https://www.credential.net/profile/ivanalejandroderlichderlich65413')}
                >
                    <div className={`${socialMediaStyles.logo} ${styles.certifications}`} />
