      ...
      <div className="About" id="about">
        ...
        <div className="skills">
          <div className="capabilities-supra">
            <div onClick={()=> this.toggleContent("languages")} className="capabilities">
              <div>Languages</div>
              <i id="arrow-right-languages" className="fas fa-chevron-right"></i>
              <i id="arrow-down-languages" className="fas fa-chevron-down hide"></i>
            </div>
            <div id="languages-content" className="languages-content hide">
              <div className="skills-item">
                <img src={javaScriptImage} alt="JavaScript" className="skills-image"/>
                <div>JavaScript</div>
              </div>
              <div className="skills-item">
                <img src={HTMLImage} alt="HTML" className="skills-image"/>
                <div>HTML</div>
              </div>
              <div className="skills-item">
                <img src={CSSImage} alt="CSS" className="skills-image"/>
                <div>CSS</div>
              </div>            
              <div className="skills-item">
                <img src={rubyImage} alt="Ruby" className="skills-image"></img>
                <div>Ruby</div>
              </div>
            </div>
          </div>
          <div className="capabilities-supra">
            <div onClick={()=> this.toggleContent("frameworks")} className="capabilities">
              <div>Frameworks</div>
              <i id="arrow-right-frameworks" className="fas fa-chevron-right"></i>
              <i id="arrow-down-frameworks" className="fas fa-chevron-down hide"></i>
            </div>
            <div id="frameworks-content" className="frameworks-content hide">        
              <div className="skills-item">
                <img src={railsImage} alt="Rails" className="skills-image"></img>
                <div>Rails</div>
              </div>
              <div className="skills-item">
                <img src={reactImage} alt="React" className="skills-image"></img>
                <div>React</div>
              </div>
              <div className="skills-item">
                <img src={phaserImage} alt="Phaser" className="skills-image"></img>
                <div>Phaser</div>
              </div>                 
            </div>        
          </div>
          <div className="capabilities-supra">
            <div onClick={()=> this.toggleContent("skills")} className="capabilities">
              <div>Skills</div>
              <i id="arrow-right-skills" className="fas fa-chevron-right"></i>
              <i id="arrow-down-skills" className="fas fa-chevron-down hide"></i>
            </div>
            <div id="skills-content" className="skills-content hide">
              <div className="skills-item">
                <img src={TDDImage} alt="TDD" className="skills-image"></img>
                <div>Test Driven Development</div>
              </div>  
              <div className="skills-item">
                <img src={pairProgrammingImage} alt="Pair Programming" className="skills-image"></img>
