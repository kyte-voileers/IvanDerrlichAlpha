    ...
    return(
        ...
        >
            ...
            <div className={styles.grid}>
                ...
                <div 
                    className={styles.button}
                    onClick={()=> clickHandler('https://stackoverflow.com/users/4363972')}
                    onAuxClick={()=> clickHandler('https://stackoverflow.com/users/4363972')}
                >
                ...
                <div 
                    className={styles.button}
                    onClick={()=> clickHandler('https://www.youtube.com/channel/UCZYxGdqKsS4HNwT1e9OV8YQ')}
                    onAuxClick={()=> clickHandler('https://www.youtube.com/channel/UCZYxGdqKsS4HNwT1e9OV8YQ')}
                >
